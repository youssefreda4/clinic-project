                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="container ">
                            ...
                            <form action="<?= helperFunction::adminUrl("index.php?page=create-major") ?>" method="POST" enctype="multipart/form-data" class="m-5">

                                <!-- Doctor Name -->
                                <div class="mb-3">
                                    <label for="doctorName" class="form-label">Major Name</label>
