                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($clinics as $clinic) : ?>
                                        <tr>
                                            ...
                                            <th class="text-center"><?= $clinic["clinic_name"]; ?></th>
                                            <th class="text-center"><?= $clinic["address"]; ?></th>

                                            <th class="text-center">
                                                <a href="<?= helperFunction::adminUrl("index.php?page=delete-clinic&clinic_id=" . $clinic["id"]) ?>" class="btn btn-danger">Delete</a>
                                            </th>
                                        </tr>
                                    <?php endforeach; ?>
